...
int NcnnDetector::initNcnnNetwork (const char* model_bin, const char* model_param, airuntime::DeviceType device)
{
    ...
    if(airuntime::DeviceType device == airuntime::DeviceType::GPU)
    {
